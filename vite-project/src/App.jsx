...
const LoadingSpinner = () => (
  <div className="w-32 h-32 relative flex items-center justify-center fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
...
const PageTransitionn = ({ children }) => {
  return (
    <TransitionGroup>
      <CSSTransition
        classNames="page"
...
const App =()=>{
  return ( 
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 " >
      ...
      <Routes>
        {/* Default Route */}
        <Route path="/" element={<PageTransitionn><Home/></PageTransitionn>} />

        {/* Other Routes */}
        
        <Route path="/experts" element={<PageTransitionn><Experts /></PageTransitionn>} />
        <Route path="/experts/:speciality" element={<Experts />}/>
        <Route path="/login" element={<Login />}/>
        <Route path="/myAppointments" element={<MyAppointments />} />
        <Route path="/myProfile" element={<MyProfile />} />
        <Route path="/about" element={<PageTransitionn><About /></PageTransitionn>} />
        <Route path="/contact" element={<Contact />} />
        <Route path="/appointments/:docId" element={<Appointments />} />
        <Route path="/submitReview/:expertId/:userId" element={<SubmitReviewForm />} />
